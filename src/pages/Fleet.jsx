...
import { formatEuro, formatGameTime, computeDealerOffer, getVehicleProfile, getVehicleBodyType } from "@/lib/gameData";
    ...
    <div className="px-4 sm:px-6 lg:px-12 py-6 lg:py-10 max-w-[1600px] mx-auto space-y-6">
      ...
      <div className="flex items-end justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button onClick={lease} disabled={state.company.accountCents < 150000}
            ...
            <FileText className="w-4 h-4" /> Leasen
          </button>
          <button onClick={buy} disabled={state.company.accountCents < 1800000 || openCompany}
