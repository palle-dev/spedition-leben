        ...
        <>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
            {activeVehicles.map(v => {
              ...
              return (
                <div key={v.id} className={`border rounded-xl p-4 hover:border-lime/20 transition bg-gradient-to-br from-white/[0.07] to-white/[0.02] ${v.markedForSale ? "border-amber-400/30" : "border-white/10"}`}>
