...
export function buyUsedVehicle(state, { offerId, branchId }) {
  ...
  state.company.accountCents -= buyPrice;
  state.bookings = state.bookings || [];
  state.bookings.push({ min: state.gameTime, cause: "Gebrauchtfahrzeugkauf: " + offer.vehicleType, amountCents: -buyPrice, account: "company", refId: "usedbuy:" + offer.id });
