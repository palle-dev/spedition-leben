...
export default function SoundSettings() {
 ...
 <p className="mt-2 text-xs text-muted-foreground">Dezente Signale für Lieferungen und Entscheidungen. Nach dem Neuladen zum Aktivieren einmal aus- und einschalten.</p></div>;
}
