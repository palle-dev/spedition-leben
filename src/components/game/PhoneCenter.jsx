...
import { Phone, PhoneIncoming, PhoneOff, Clock, Mail, Users, PhoneMissed } from "lucide-react";
...
export default function PhoneCenter() {
 ...
 const [phoneTab,setPhoneTab]=useState("calls");
