...
const MANDATE_FIELDS = [["dailyBudgetCents","Kaufbudget pro Tag (€)",100,10,1000000000],["reserveCents","Depotreserve (€)",100,0,1000000000],["maxPositionPct","Max. Einzelposition (%)",1,5,100],["stopLossPct","Verlustgrenze (%)",1,1,90],["takeProfitPct","Gewinnziel (%)",1,1,500],["maxTradesPerDay","Max. Orders pro Tag",1,1,12]];
