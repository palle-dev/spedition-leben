    ...
    <motion.div
      ...
      className={`rounded-xl p-4 border transition-all duration-200 ${
        prog.completed
          ...
          : "border-coral/20 bg-coral/[0.03] hover:border-coral/35"
      }`}
    >
      <div className="flex items-start gap-3">
        <div className={`w-9 h-9 rounded-lg grid place-items-center shrink-0 ${
          prog.completed ? "bg-lime/15 text-lime" : "bg-coral/15 text-coral"
        }`}>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            ...
            <button onClick={() => onRemove(goal.id)} className="text-muted-foreground/50 hover:text-red-300 transition shrink-0 p-0.5" aria-label="Ziel entfernen">
