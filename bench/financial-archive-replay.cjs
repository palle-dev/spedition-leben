...
async function main(){
 ...
 for(let day=1;day<=3;day++){
  ...
  for(const key of ['company','private','drivers','vehicles','employees']) assert.deepEqual(after[key],before[key]);
